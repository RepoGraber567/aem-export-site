import { motion } from 'motion/react';import { Box, Snowflake, Ship, ShieldCheck } from 'lucide-react';import { useLanguage } from './LanguageContext';export function Logistics() {  const { t } = useLanguage();  return (    <section id="logistics" className="py-24 bg-white text-green-950">      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">        <div className="grid md:grid-cols-2 gap-16 items-center">          <motion.div            initial={{ opacity: 0, x: -20 }}            whileInView={{ opacity: 1, x: 0 }}            viewport={{ once: true }}            className="order-2 md:order-1 relative grid grid-cols-2 gap-4 h-[500px]"          >            <div className="relative rounded-sm overflow-hidden shadow-xl h-full transform -translate-y-8 group">              <img                 src="https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&q=80&w=800"                 alt="Modern shipping port"                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"              />              <div className="absolute inset-0 bg-green-950/20 mix-blend-multiply transition-opacity group-hover:opacity-0" />            </div>            <div className="relative rounded-sm overflow-hidden shadow-xl h-full transform translate-y-8 group">              <img                 src="https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?auto=format&fit=crop&q=80&w=800"                 alt="Agricultural logistics"                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"              />              <div className="absolute inset-0 bg-blue-900/20 mix-blend-multiply transition-opacity group-hover:opacity-0" />            </div>          </motion.div>          <motion.divimport { motion } from 'motion/react';
